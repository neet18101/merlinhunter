...
const digitalServices: ServiceItem[] = [
   {
      ...
      list_one: [
         {
            title: "Address Trace",
            _id: "Address Trace",
            para: `  <h1>Address Trace Investigations</h1>
    ...
    <ul>
        <li><strong>Searching public records:</strong> This can include checking property records, motor vehicle records, and voter registration records.</li>
        <li><strong>Searching databases:</strong> There are a number of commercial and government databases that can be used to search for addresses, such as Autotrace, LexisNexis, and Orbis.</li>
        <li><strong>Interviewing witnesses and associates:</strong> People who know the person or entity whose address is being traced may have information about their current whereabouts.</li>
        <li><strong>Canvassing neighbourhoods:</strong> In some cases, we may need to canvass neighbourhoods to knock on doors and ask people if they have seen the person or entity being traced.</li>
    </ul>`,
         },
    ...
    <ul>
        ...
        <li><strong>Employment background checks:</strong> These checks are conducted by employers to screen job applicants and existing employees. Employment background checks may include more sensitive information, such as criminal records and credit history.</li>
...

         {
            title: "Hidden Asset",
            _id: "Hidden Asset",
            para: ` <h1>Hidden Asset Search</h1>
    <p>A hidden asset search is an investigation conducted to uncover assets that an individual or company has intentionally concealed. These assets may be hidden for various reasons, such as to avoid paying taxes, debts, or child support, or to protect them from creditors or legal claims. Methods used in hidden asset searches:</p>

    <ul>
        <li><strong>Review of public records:</strong> This includes searching property records, business registrations, tax records, vehicle records and court filings.</li>
        <li><strong>Professional licensing records:</strong> Identifying any professional licenses held by the subject, can best indicate salary and market value.</li>
        <li><strong>Financial analysis:</strong> This involves examining bank statements, credit card records, investment accounts, and other financial documents.</li>
        <li><strong>Interviews with associates:</strong> Talking to friends, family members, business partners, or other individuals who may have knowledge of the person's assets.</li>
    </ul>`,
         },
         {
            title: "Social Media Investigation",
            _id: "Social Media Investigation",
            para: ` <h1>Social Media Investigation</h1>
    ...
    <ul>
        <li><strong>Keyword searches:</strong> We can search for specific keywords on social media platforms to identify relevant posts and profiles.</li>
        <li><strong>Geolocation searches:</strong> We can also search for posts that were made from a specific location. This can be useful for identifying witnesses to a crime or for tracking the movements of a suspect.</li>
        <li><strong>Relationship mapping:</strong> We can use social media platforms to map out the relationships between different individuals and organisations. This can be useful for identifying potential accomplices or co-conspirators.</li>
        <li><strong>Open source intelligence (OSINT):</strong> We can also use OSINT tools to gather information about individuals and organisations from social media platforms. OSINT tools can be used to identify hidden profiles, track down deleted posts, and uncover other hidden information.</li>
    </ul>`,
         },

         {
            title: "Fact Finding Investigation",
            _id: "Fact Finding Investigation",
            para: `<h1>False Allegation Investigation</h1>
    <p>A false allegation investigation is the process of gathering evidence to determine whether an allegation is false. This can be a complex and challenging process, as it often involves conflicting testimony and limited evidence. False allegations can be made for a variety of reasons, such as retaliation, revenge, or personal gain.</p>
    ...
    <ul>
        <li><strong>Identify the scope of the allegation:</strong> This includes determining the type of allegation that is being made, the date and time of the alleged incident, and the parties that are involved.</li>
        <li><strong>Interview the complainant and the accused:</strong> This is an important step in gathering information about the allegation and in assessing the credibility of the parties involved.</li>
        <li><strong>Review evidence:</strong> This may include witness statements, physical evidence, and electronic records and identify patterns and trends that may indicate whether the allegation is true or false.</li>
        <li><strong>Draw conclusions:</strong> Based on the evidence gathered, the investigator will draw conclusions about whether the allegation is likely to be true or false.</li>
        <li><strong>Report the findings:</strong> The investigator will typically prepare a report that summarises the findings of the investigation and recommends further action, such as disciplinary action against the accused or criminal prosecution of the complainant.</li>
    </ul>`,
         },
